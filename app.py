...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/Housing-Data-test-kk/master/prepared_data.csv')
...
encoder_location = 'https://github.com/karthikreddykuna/Housing-Data-test-kk/blob/master/encoder.pkl?raw=true'
